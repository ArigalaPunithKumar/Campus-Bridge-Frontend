...
const AdminDashboard = () => {
    ...
    const fetchAllData = async () => {
        ...
        try {
            ...
            const [statsRes, usersRes] = await Promise.all([
                ...
                axios.get("https://campus-bridge-backend.onrender.com/api/admin/stats"),

                axios.get("https://campus-bridge-backend.onrender.com/api/admin/users")
    ...
    const handleStatusToggle = async (id, currentStatus) => {
        ...
        try {
            ...
            await axios.put(`https://campus-bridge-backend.onrender.com/api/admin/user-status/${id}`, { status: newStatus });
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            await axios.delete(`https://campus-bridge-backend.onrender.com/api/admin/user/${id}`);
    ...
    const handleResetPassword = async (id) => {
        ...
        try {
            ...
            await axios.put(`https://campus-bridge-backend.onrender.com/api/admin/reset-password/${id}`);
    ...
    const SettingsView = () => {
        ...
        const fetchSettings = async () => {
            ...
            try {
                ...
                const res = await axios.get("https://campus-bridge-backend.onrender.com/api/admin/settings");
        ...
        const handleToggle = async (key) => {
            ...
            try {
                ...
                await axios.post("https://campus-bridge-backend.onrender.com/api/admin/settings/toggle", { key });
