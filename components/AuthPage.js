...
const AuthPage = () => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("https://campus-bridge-backend.onrender.com/api/auth/register", registerData);
            alert(res.data.msg);
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post("https://campus-bridge-backend.onrender.com/api/auth/login", loginData);
            const { user } = res.data;
    ...
    const handleForgotPassword = async () => {
        try {
            await axios.post("https://campus-bridge-backend.onrender.com/api/auth/forgot-password", { email: forgotEmail });
    ...
    const handleOtpVerify = async () => {
        try {
            await axios.post("https://campus-bridge-backend.onrender.com/api/auth/verify-otp", { email: forgotEmail, otp });
    ...
    const handleResetPassword = async () => {
        try {
            await axios.post("https://campus-bridge-backend.onrender.com/api/auth/reset-password", { email: forgotEmail, newPassword });
