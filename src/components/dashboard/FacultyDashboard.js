...
const notifyStudent = async (studentId, type, message) => {
    try {
        await axios.post("https://campus-bridge-backend.onrender.com/api/notifications/create", {
...
const notifyBatch = async (notificationArray) => {
    try {
        await axios.post("https://campus-bridge-backend.onrender.com/api/notifications/batch", {
...
const CoursesView = ({ newCourse, setNewCourse, handleCreateCourse, courses }) => {
    ...
    const handleEnroll = async () => {
        ...
        try {
            await axios.post("https://campus-bridge-backend.onrender.com/api/faculty/enroll", {
...
const FacultyDashboard = () => {
    ...
    const fetchDashboardData = async (fid) => {
        try {
            const res = await axios.get(`https://campus-bridge-backend.onrender.com/api/faculty/dashboard/${fid}`);
            setStats(res.data.stats);
            setCourses(res.data.courses);
            if (res.data.courses.length > 0 && !selectedCourseId) setSelectedCourseId(res.data.courses[0].id);
        } catch (err) { console.error(err); }
    };
    const fetchStudents = async (cid) => { try { const res = await axios.get(`https://campus-bridge-backend.onrender.com/api/faculty/students/${cid}`); setStudents(res.data); } catch (e) { } };
    const fetchSchedule = async () => { try { const res = await axios.get(`https://campus-bridge-backend.onrender.com/api/faculty/schedule/${faculty.id}`); setSchedule(res.data); } catch (e) { } };
    const fetchSubmissions = async () => { try { const res = await axios.get(`https://campus-bridge-backend.onrender.com/api/faculty/submissions/${faculty.id}`); setSubmissions(res.data); } catch (e) { } };
    ...
    const fetchAllStudents = async () => {
        try {
            const res = await axios.get("https://campus-bridge-backend.onrender.com/api/faculty/students/all");
            return res.data;
        } catch (e) {
    ...
    const handleCreateCourse = async () => {
        try {
            // 1. Create the Course
            await axios.post("https://campus-bridge-backend.onrender.com/api/faculty/create-course", {
    ...
    const handlePostAssignment = async () => {
        ...
        try {
            // 1. Post Assignment
            await axios.post("https://campus-bridge-backend.onrender.com/api/faculty/assignments", newAssignment);

            // 2. Fetch students specifically for THIS course
            const res = await axios.get(`https://campus-bridge-backend.onrender.com/api/faculty/students/${newAssignment.courseId}`);
    ...
    const handleSaveAttendance = async () => {
        try {
            // 1. Save Attendance
            await axios.post("https://campus-bridge-backend.onrender.com/api/faculty/attendance", {
    ...
    const handleAddClass = async () => {
        await axios.post("https://campus-bridge-backend.onrender.com/api/faculty/schedule", { ...newClass, facultyId: faculty.id });
        alert("Class Added!");
        fetchSchedule();
    };
    ...
    const handleGradeSubmission = async (sid, score) => {
        try {
            // 1. Save Grade
            await axios.post("https://campus-bridge-backend.onrender.com/api/faculty/grade", { submissionId: sid, score });
